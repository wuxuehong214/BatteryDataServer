...
<head>
<meta charset="utf-8">
<title><s:text name="left.account.customer" />--Greenway</title>
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title"><s:text name="left.account.customer" /></h1>
			<ul class="breadcrumb">
				<li><a href="User_dashboard"><s:text name="global.index" /></a></li>
				<li class="active"><s:text name="left.account.customer" /></li>
			</ul>
		</div>

		<div class="btn-toolbar list-toolbar">
			<a href="Lang_jsp?page=user_add" class="btn btn-primary">
				<i class="fa fa-plus"></i> <s:text name="user.customer.add"/>
			</a>
		...
		<table id="example" class="data display datatable" cellspacing="0"
			...
			<thead>
				<tr>
					<th><s:text name="user.customer.account" /></th>
		...
		<form action="User_del" method="post" name="subForm2"
						id="subFormId2">
			<input type="hidden" id="uid" name="user.id"/> 
			<input type="hidden" id="pageid" name="page" value="user_manage"/>
		</form>
		
		<form action="User_query" method="post" name="subForm3"
						id="subFormId3">
			<input type="hidden" id="uid2" name="user.id"/> 
			<input type="hidden" id="pageid" name="page" value="user_edit"/>
		</form>
