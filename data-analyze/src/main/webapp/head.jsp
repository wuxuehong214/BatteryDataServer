		...
		<ul id="main-menu" class="nav navbar-nav navbar-right">
			<li class="dropdown hidden-xs"><a href="#"
				...
				<ul class="dropdown-menu">
					<li><a href="Lang_jsp?page=personal_profile"><s:text name="left.dashboard.profile" /></a></li>
					<li class="divider"></li>
					<!-- 
					<li class="dropdown-header">gongzuotai</li>
					 -->
					<li><a href="User_dashboard"><s:text name="left.dashboard.dashboard" /></a></li>
					<!-- 
					<li><a tabindex="-1" href="./">Payments</a></li>
					 -->
					<li class="divider"></li>
					<li><a tabindex="-1" href="User_logout"><s:text name="left.system.exit" /></a></li>
				</ul></li>
		</ul>
