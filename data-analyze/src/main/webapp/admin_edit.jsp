...
<head>
<meta charset="utf-8">
<title><s:text name="user.admin.edit" />--Greenway</title>
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
  ...
  -->
			<h1 class="page-title"><s:text name="user.admin.edit" /></h1>
			<ul class="breadcrumb">
				...
				<li class="active"><s:text name="user.admin.edit" /></li>
			</ul>
				...
				<form id="tab" action="User_update" method="post" name="form1" id="formId">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade" id="home">
							...
							<div class="form-group">
								<label><s:text name="user.mail"/></label> <input type="text"
