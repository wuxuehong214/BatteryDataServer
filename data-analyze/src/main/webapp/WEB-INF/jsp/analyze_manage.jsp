	...
	<script type="text/javascript">
		...
		function init() {
			...
			$("#uploadify").uploadify({
				...
				'uploader' : 'upload?path=' +  document.getElementById("taskId").value,//请求路径    
				...
				'multi' : true, //允许多文件上传    
				'buttonText' : '上传电池数据(*.GWR *.GWI)',//按钮上的文字    
		...
		<div class="header">
			...
			<div class="stats">
				...
				<label class="fa fa-warning"></label>
					<label class="label label-warning">*注意: 需要同时上传.GWR以及.GWI文件</label>
				</p>
			</div>

			<h1 class="page-title">电池诊断</h1>
			<ul class="breadcrumb">
				<li><a href="User_dashboard">首页</a></li>
				<li class="active">电池诊断</li>
			</ul>
				...
				<div class="col-md-6">
					<form action="Task_submit" method="post" name="subForm"
						...
						<div class="form-group">
							<label><strong>诊断任务名称</strong></label>
							 <input type="text" value="电池诊断"
						...
						<div class="btn-toolbar list-toolbar">
							<a href="#myModal" data-toggle="modal" class="btn btn-primary"
								disabled id="subtn"><i class="fa fa-save"></i>提交分析</a>
						</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p class="error-text">
								<i class="fa fa-warning modal-icon"></i>确认要提交本次诊断任务么?<br>提交后任务执行时间会较长.
							</p>
						</div>
