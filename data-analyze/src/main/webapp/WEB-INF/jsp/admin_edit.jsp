						...
						<div class="tab-pane fade" id="home">
							<div class="form-group">
								<label>姓名</label> <input type="text"
									...
									<input type="hidden" value="admin_edit" name="page">
									<input type="hidden" value='<s:property value="user.id"/>' name="user.id">
							</div>
							<div class="form-group">
							
								<label>性别</label> <br> <input type="radio" value="0"
									name="user.sex" <s:if test="user.sex==0">checked</s:if>>男 &nbsp;&nbsp;&nbsp;&nbsp; <input
									type="radio" value="1" name="user.sex" <s:if test="user.sex==1">checked</s:if>>女
							</div>
							<div class="form-group">
