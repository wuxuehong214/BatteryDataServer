...
<head>
<meta charset="utf-8">
<title><s:text name="user.customer.add" />--Greenway</title>
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
 ...
 -->
			<h1 class="page-title"><s:text name="user.customer.add" /></h1>
			<ul class="breadcrumb">
				...
				<li class="active"><s:text name="user.customer.add" /></li>
			</ul>
				...
				<form id="tab" action="User_add" method="post" name="form1" id="formId">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade" id="home">
							<div class="form-group">
								<label><s:text name="user.name"/></label> <input type="text"
									...
									<input type="hidden" value="user_manage" name="pagetmp">
							</div>
							<div class="form-group">
						...
						<div class="tab-pane active in" id="profile">
							...
							<div class="form-group">
								<label><s:text name="login.form.username"/></label> <input type="text" class="form-control" id="uidd"
									name="user.userName">
							</div>
							<div class="form-group">
