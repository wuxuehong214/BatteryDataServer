...
<head>
<meta charset="utf-8">
<title><s:text name="left.diag.mine" />--Greenway</title>
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
	...
	<div class="content">
		<div class="header">
			...
			<h1 class="page-title"><s:text name="left.diag.mine" /></h1>
			<ul class="breadcrumb">
				<li><a href="User_dashboard"><s:text name="global.index" /></a></li>
				<li class="active"><s:text name="left.diag.mine" /></li>
			</ul>
		...
		<form action="Task_del" method="post" name="subForm2"
						id="subFormId2">
